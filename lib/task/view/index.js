 ...
 * @return {Array}              视图信息
 */
function get_view_info(module_info){
    ...
    sub_modules.forEach(function(sub_module_info){
      ...
      if(fs.existsSync(module_path)){
        view_info.modules.push(get_view_info(sub_module_info));
      }else{
        view_info.modules = view_info.modules.concat(get_view_info(sub_module_info).modules);
      }
    });
...
exports.info = function(page_info){
  return mod.format(get_view_info(page_info.module()));
};
