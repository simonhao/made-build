...
require = (function(modules, entry){
  ...
  return new_require;
})({"made-instance": function(require, module, exports){
/**
 * Made-Instance
 * @author: SimonHao
...
},"made-script/runtime": function(require, module, exports){
/**
 * MadeScript Runtime
 * @author: SimonHao
...
window.__made = exports;
},"jquery/dist/jquery": function(require, module, exports){
/*!
...
typeof window !== 'undefined' ? window : this, function (window, noGlobal) {
    ...
    function (window) {
        ...
        function Sizzle(selector, context, results, seed) {
            ...
            if (!seed && documentIsHTML) {
                ...
                if (nodeType !== 11 && (match = rquickExpr.exec(selector))) {
                    ...
                    } else // Speed-up: Sizzle("TAG")
                    if (match[2]) {
                        push.apply(results, context.getElementsByTagName(selector));
                        return results;    // Speed-up: Sizzle(".CLASS")
                    } else // Speed-up: Sizzle(".CLASS")
        ...
        setDocument = Sizzle.setDocument = function (node) {
            var hasCompare, parent, doc = node ? node.ownerDocument || node : preferredDoc;    // If no document and documentElement is available, return
            ...
            Expr.find['TAG'] = support.getElementsByTagName ? function (tag, context) {
                ...
                } else // DocumentFragment nodes don't have gEBTN
                if (support.qsa) {
            ...
            sortOrder = hasCompare ? function (a, b) {
                ...
                } else // If the nodes are siblings, we can do a quick check
                if (aup === bup) {
        ...
        Expr = Sizzle.selectors = {
            ...
            preFilter: {
                ...
                'PSEUDO': function (match) {
                    ...
                    } else // Strip excess characters from unquoted arguments
        ...
        select = Sizzle.select = function (selector, context, results, seed) {
            ...
            if (match.length === 1) {
                ...
                if (tokens.length > 2 && (token = tokens[0]).type === 'ID' && support.getById && context.nodeType === 9 && documentIsHTML && Expr.relative[tokens[1].type]) {
                    ...
                    } else // Precompiled matchers will still verify ancestry, so step up a level
                    if (compiled) {
            ...
            self = {
                ...
                add: function () {
                    if (list) {
                        ...
                        } else // With memory, if we're not firing then
                        // we should call right away
                        if (memory) {
                            firingStart = start;
                            fire(memory);
    ...
    (function () {
        var fragment = document.createDocumentFragment(), div = fragment.appendChild(document.createElement('div')), input = document.createElement('input');    // Support: Safari<=5.1
    ...
    jQuery.event = {
        ...
        dispatch: function (event) {
            ...
            var i, j, ret, matched, handleObj, handlerQueue = [], args = slice.call(arguments), handlers = (data_priv.get(this, 'events') || {})[event.type] || [], special = jQuery.event.special[event.type] || {};    // Use the fix-ed jQuery.Event rather than the (read-only) native event
    ...
    function fixInput(src, dest) {
        ...
        } else // Fails to return the selected option to the default selected state when cloning options
        ...
        buildFragment: function (elems, context, scripts, selection) {
            ...
            for (; i < l; i++) {
                ...
                if (elem || elem === 0) {
                    ...
                    } else // Convert non-html into a text node
                    if (!rhtml.test(elem)) {
    ...
    jQuery.fn.extend({
        ...
        domManip: function (args, callback) {
            ...
            var fragment, first, scripts, hasScripts, node, doc, i = 0, l = this.length, set = this, iNoClone = l - 1, value = args[0], isFunction = jQuery.isFunction(value);    // We can't cloneNode fragments that contain checked, in WebKit
    ...
    var fxNow, timerId, rfxtypes = /^(?:toggle|show|hide)$/, rfxnum = new RegExp('^(?:([+-])=|)(' + pnum + ')([a-z%]*)$', 'i'), rrun = /queueHooks$/, animationPrefilters = [defaultPrefilter], tweeners = {
            '*': [function (prop, value) {
                    ...
                    if (start && start[3] !== unit) {
                        ...
                        } while (// Update scale, tolerating zero or NaN from tween.cur(),
                        // break the loop if scale is unchanged or perfect, or if we've just had enough
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        } else // If this is a noop like .hide().hide(), restore an overwritten display value
...
.end().animate({ opacity: to }, speed, easing, callback);
    ...
    function ajaxConvert(s, response, jqXHR, isSuccess) {
        ...
        while (current) {
            ...
            if (current) {
                ...
                } else // Convert response if prev dataType is non-auto and differs from current
                        ...
                        for (conv2 in converters) {
                            ...
                            if (tmp[1] === current) {
                                ...
                                if (conv) {
                                    ...
                                    } else // Otherwise, insert the intermediate dataType
    ...
    jQuery.fn.load = function (url, params, callback) {
        ...
        } else // Otherwise, build a param string
...
},"inherits/inherits_browser": function(require, module, exports){
...
},"made-module": function(require, module, exports){
/**
 * Made-Module
 * @author: SimonHao
 * @date:   2015-11-13 11:27:55
...
},"comm/layout": function(require, module, exports){
/**
 * layout entry
 * @author: SimonHao
...
var Layout = __made.create_class(function Layout(options, instance) {
    Module.call(this);
    this.bind();
}, [
    {
        bind: {
            value: function () {
                var classname = '.comm-layout-header';
                var id = '#comm-layout-' + (instance ? instance + '-' : '') + 'header';
                var src = '/../test/src/comm/admin/frame/readme.md';
                var instance = 'comm-layout' + (instance ? '-' + instance : '') + '-top';
            }
        },
        destructor: {
            value: function () {
...
exports._default = Layout;
}},["made-instance","made-script/runtime"]);